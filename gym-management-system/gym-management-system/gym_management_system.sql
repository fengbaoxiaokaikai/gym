...
CREATE TABLE `coupon`  (
  ...
  `coupon_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '优惠券类型',
  `discount_amount` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '优惠金额或折扣值',
  `minimum_amount` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '最低消费金额',
...
-- Records of coupon
-- ----------------------------
INSERT INTO `coupon` VALUES (1, 'NEW50', '新会员立减券', '满减', 50.00, 300.00, '2026-07-01', '2026-12-31', '启用', 100, '新会员办卡可用');
INSERT INTO `coupon` VALUES (2, 'COURSE88', '课程折扣券', '折扣', 8.80, 0.00, '2026-07-01', '2026-09-30', '启用', 60, '私教课程报名可用');
INSERT INTO `coupon` VALUES (3, 'SUMMER20', '夏季训练优惠', '满减', 20.00, 120.00, '2026-07-01', '2026-08-31', '停用', 0, '活动已暂停');
