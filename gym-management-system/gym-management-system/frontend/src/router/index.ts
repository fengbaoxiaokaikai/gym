...
import CouponSelCoupon from '../pages/CouponSelCoupon.vue'
import CouponToAddCoupon from '../pages/CouponToAddCoupon.vue'
import CouponToUpdateCoupon from '../pages/CouponToUpdateCoupon.vue'
...
const routes = [
  ...
  { path: '/coupon/selCoupon', component: CouponSelCoupon, meta: { requiresAuth: true, role: 'admin' } },
  { path: '/coupon/toAddCoupon', component: CouponToAddCoupon, meta: { requiresAuth: true, role: 'admin' } },
  { path: '/coupon/toUpdateCoupon', component: CouponToUpdateCoupon, meta: { requiresAuth: true, role: 'admin' } },
